...
public class GalleryAdapter extends BaseAdapter {
	...
	public void replace(int position, CustomGallery obj) {
		data.set(position, obj);
		notifyDataSetChanged();
	}

	public void remove(int position) {
		MainActivity.MAX_IMAGE_SELECTION_LENGTH++;
	...
	public void clear() {
		MainActivity.MAX_IMAGE_SELECTION_LENGTH = R.integer.photo_limit;
		data.clear();
		notifyDataSetChanged();
	}
}
