...
public class MainImageEditActivity extends Activity {

    public static final String LOG_TAG = MainImageEditActivity.class.getName();
    private static final int ACTION_REQUEST_GALLERY = 99;
    private static final int ACTION_REQUEST_FEATHER = 100;
    private static final int EXTERNAL_STORAGE_UNAVAILABLE = 1;
    /** Folder name on the sdcard where the images will be saved * */
    private static final String FOLDER_NAME = "aviary-picturethis";
    ...
    Uri mImageUri;
    int imageWidth, imageHeight, imgPosition;
    File mGalleryFolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageUri = Uri.parse(intent.getStringExtra("uri"));
    ...
    class DownloadAsync extends AsyncTask<Uri, Void, Bitmap> implements
        ...
        protected void onPreExecute() {
            ...
            mProgress = new ProgressDialog(MainImageEditActivity.this);
        ...
        protected Bitmap doInBackground(Uri... params) {
            ...
            bitmap = DecodeUtils.decode(
                MainImageEditActivity.this, mUri, imageWidth,
                imageHeight, info);
            return bitmap;
        }
